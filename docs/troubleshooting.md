...
|---|---|---|
| `allow` | `permissionDecision: "allow"` | Mapped, and the Vinctor service permitted it. Codex runs the tool. |
...
If you expect a deny/allow but the tool runs without any hook decision, confirm
