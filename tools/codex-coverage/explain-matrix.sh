...
check "Bash npm publish"          "deploy:pkg/npm/_"     '{"hook_event_name":"PreToolUse","tool_name":"Bash","tool_input":{"command":"npm publish"}}'
check "Bash npm test"             "execute:shell/npm"    '{"hook_event_name":"PreToolUse","tool_name":"Bash","tool_input":{"command":"npm test"}}'
check "Bash git push --force"     "delete:git/push-force" '{"hook_event_name":"PreToolUse","tool_name":"Bash","tool_input":{"command":"git push --force origin main"}}'
check "Bash git status"           "read:shell/git"       '{"hook_event_name":"PreToolUse","tool_name":"Bash","tool_input":{"command":"git status"}}'
check "Bash docker push"          "deploy:container/docker.io/x" '{"hook_event_name":"PreToolUse","tool_name":"Bash","tool_input":{"command":"docker push x"}}'
