...
# `*** Begin Patch` shape and the `input` field name (see src/apply-patch.ts).
...
write_event ap_add        '{"hook_event_name":"PreToolUse","tool_name":"apply_patch","tool_input":{"input":"*** Begin Patch\n*** Add File: package.json\n+{}\n*** End Patch"}}'
write_event ap_update     '{"hook_event_name":"PreToolUse","tool_name":"apply_patch","tool_input":{"input":"*** Begin Patch\n*** Update File: config/.env\n+A=1\n*** End Patch"}}'
write_event ap_delete     '{"hook_event_name":"PreToolUse","tool_name":"apply_patch","tool_input":{"input":"*** Begin Patch\n*** Delete File: .github/workflows/ci.yml\n*** End Patch"}}'
write_event ap_move       '{"hook_event_name":"PreToolUse","tool_name":"apply_patch","tool_input":{"input":"*** Begin Patch\n*** Update File: src/old.ts\n*** Move to: config/.env\n+A=1\n*** End Patch"}}'
write_event ap_multi      '{"hook_event_name":"PreToolUse","tool_name":"apply_patch","tool_input":{"input":"*** Begin Patch\n*** Update File: package.json\n+x\n*** Delete File: .github/workflows/ci.yml\n*** End Patch"}}'
write_event ap_ordinary   '{"hook_event_name":"PreToolUse","tool_name":"apply_patch","tool_input":{"input":"*** Begin Patch\n*** Update File: src/index.ts\n+x\n*** End Patch"}}'
