...
check "apply_patch Add package.json"     "write:repo/manifest/npm" '{"hook_event_name":"PreToolUse","tool_name":"apply_patch","tool_input":{"input":"*** Begin Patch\n*** Add File: package.json\n+{}\n*** End Patch"}}'
check "apply_patch Update .env"          "write:secret/env"        '{"hook_event_name":"PreToolUse","tool_name":"apply_patch","tool_input":{"input":"*** Begin Patch\n*** Update File: config/.env\n+A=1\n*** End Patch"}}'
check "apply_patch Delete ci.yml"        "delete:ci/workflow"      '{"hook_event_name":"PreToolUse","tool_name":"apply_patch","tool_input":{"input":"*** Begin Patch\n*** Delete File: .github/workflows/ci.yml\n*** End Patch"}}'
check "apply_patch Move into .env"       "write:secret/env"        '{"hook_event_name":"PreToolUse","tool_name":"apply_patch","tool_input":{"input":"*** Begin Patch\n*** Update File: src/old.ts\n*** Move to: config/.env\n+A=1\n*** End Patch"}}'
check "apply_patch multi (destructive)"  "delete:ci/workflow"      '{"hook_event_name":"PreToolUse","tool_name":"apply_patch","tool_input":{"input":"*** Begin Patch\n*** Update File: package.json\n+x\n*** Delete File: .github/workflows/ci.yml\n*** End Patch"}}'
check "apply_patch ordinary (abstain)"   "abstain"                 '{"hook_event_name":"PreToolUse","tool_name":"apply_patch","tool_input":{"input":"*** Begin Patch\n*** Update File: src/index.ts\n+x\n*** End Patch"}}'
