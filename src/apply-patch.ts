...
/**
 * The patch text from an apply_patch tool_input. Current Codex releases carry
 * the envelope under `command`; `input` and `patch` remain accepted for older
 * or compatible runtimes. Returns the first non-empty string found, else null.
 */
