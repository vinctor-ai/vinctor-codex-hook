...
/**
 * Vinctor emits only `deny`. A permitted or unmapped call continues with empty
 * stdout. Bare `allow` and `ask` decisions are unsupported by current Codex.
 */
export type Decision = "deny";
